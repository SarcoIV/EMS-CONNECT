const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-yhQgm3sn.js","assets/app-BXiEeO0S.js","assets/app-DFVg7nBz.css"])))=>i.map(i=>d[i]);
import{r,a as Z,_,j as e}from"./app-BXiEeO0S.js";import{S as xe,H as ue}from"./sidebar-CcoAF1_4.js";import{I as me}from"./IncomingCallNotification-Cp9vz87Y.js";import he from"./ResponderMonitoring-B_jTscKk.js";/* empty css            */import"./index-BT1eRjSb.js";import"./input-BrqDLNR5.js";import"./dropdown-menu-BH2dXFdg.js";const fe=5e3,x={pending:"#f59e0b",dispatched:"#3b82f6",completed:"#10b981",cancelled:"#6b7280"},f={idle:"#10b981",assigned:"#f59e0b",en_route:"#3b82f6",arrived:"#8b5cf6",busy:"#ef4444",offline:"#6b7280"},D={assigned:"#f59e0b",accepted:"#3b82f6",en_route:"#3b82f6",arrived:"#8b5cf6",completed:"#10b981",cancelled:"#6b7280"},g={medical:"🏥",fire:"🔥",accident:"🚗",crime:"🚨",natural_disaster:"🌊",other:"⚠️"};function Le({user:G,incidents:k,activeCalls:J,activeDispatches:W,activeResponders:q,focusedIncidentId:z}){var H,B,F;const[b,K]=r.useState(k),[j,Q]=r.useState(J),[T,X]=r.useState(W),[Y,ee]=r.useState(q),[i,y]=r.useState(null),[ge,te]=r.useState(null),[u,P]=r.useState(null),[L,se]=r.useState("all"),[C,ae]=r.useState("all"),[M,re]=r.useState(!1),[ne,le]=r.useState(new Date),n=r.useRef(null),$=r.useRef(null),R=r.useRef([]),w=r.useRef([]),A=r.useRef([]),h=r.useRef(null),U=b.filter(t=>!(L!=="all"&&t.status!==L||C!=="all"&&t.type!==C||M&&t.status==="completed")),S=r.useCallback(async()=>{try{console.log("[LIVEMAP] 🔄 Refreshing map data...");const t=await Z.get("/admin/live-map/data");K(t.data.incidents),Q(t.data.activeCalls),X(t.data.activeDispatches||[]),ee(t.data.activeResponders||[]),le(new Date),V(t.data.incidents),oe(t.data.activeDispatches||[],t.data.activeResponders||[])}catch(t){console.error("[LIVEMAP] ❌ Failed to fetch map data:",t)}},[]);r.useEffect(()=>((async()=>{if(typeof window>"u")return;const o=(await _(async()=>{const{default:a}=await import("./leaflet-src-yhQgm3sn.js").then(d=>d.l);return{default:a}},__vite__mapDeps([0,1,2]))).default;if(delete o.Icon.Default.prototype._getIconUrl,o.Icon.Default.mergeOptions({iconRetinaUrl:"https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/images/marker-icon-2x.png",iconUrl:"https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/images/marker-icon.png",shadowUrl:"https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/images/marker-shadow.png"}),$.current&&!n.current){const a=[14.5995,120.9842];if(n.current=o.map($.current).setView(a,12),o.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',maxZoom:19}).addTo(n.current),V(k),z){const d=k.find(p=>p.id===z);d&&(n.current.setView([d.latitude,d.longitude],16),y(d))}}})(),()=>{n.current&&(n.current.remove(),n.current=null)}),[]);const V=async t=>{if(!n.current)return;const o=(await _(async()=>{const{default:a}=await import("./leaflet-src-yhQgm3sn.js").then(d=>d.l);return{default:a}},__vite__mapDeps([0,1,2]))).default;R.current.forEach(a=>a.remove()),R.current=[],t.forEach(a=>{var c,m;if(!a.latitude||!a.longitude)return;const d=`
                <div style="
